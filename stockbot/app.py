...
import pandas as pd
from bot4 import fetch_intraday_data, add_indicators, add_advanced_indicators, generate_advanced_signal, log_signal, send_telegram_message
...
if st.button("🚀 Start Monitoring"):
    if not selected_names:
        ...
        st.balloons()
        st.info("Signals sent to Telegram.")
